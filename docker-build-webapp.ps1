...
try {
    ...
    $IgnorePathes = 'bin', 'obj', 'node_modules', '.git', '.vs', '.vscode', '.env', '.env.example'
    ...
    Copy-Clean "./BuyAlan.WebApp" (Join-Path $TempDir "BuyAlan.WebApp") $IgnorePathes
