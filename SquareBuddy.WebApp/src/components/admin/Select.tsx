...
const selectTriggerStyles = [
  cx(
    ...
    focusInput,
    // invalid (optional)
    // "aria-[invalid=true]:dark:ring-gray-400/20 aria-[invalid=true]:ring-2 aria-[invalid=true]:ring-gray-200 aria-[invalid=true]:border-gray-500 invalid:ring-2 invalid:ring-gray-200 invalid:border-gray-500"
  ),
]
  ...
  return (
    <SelectPrimitives.Item
      ...
      className={cx(
        ...
        "text-gray-900 dark:text-gray-50",
        // disabled
        "data-[disabled]:pointer-events-none data-[disabled]:text-gray-400 data-[disabled]:hover:bg-transparent dark:data-[disabled]:text-gray-600",
        // focus
