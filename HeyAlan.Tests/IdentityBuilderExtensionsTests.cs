...
{
    [Theory]
    [InlineData("https://heyalan.test", "/auth/providers/google/callback", "https://heyalan.test/api/auth/providers/google/callback")]
    [InlineData("https://heyalan.test/", "/auth/providers/google/callback", "https://heyalan.test/api/auth/providers/google/callback")]
    [InlineData("https://heyalan.test/tenant", "/auth/providers/google/callback", "https://heyalan.test/tenant/api/auth/providers/google/callback")]
    [InlineData("https://heyalan.test/tenant/", "/auth/providers/google/callback", "https://heyalan.test/tenant/api/auth/providers/google/callback")]
    ...
    {
        Uri baseUri = new("https://heyalan.test");
    ...
    public void ReplaceQueryParameter_ReplacesExistingValue()
    {
        ...
        string rewritten = IdentityBuilderExtensions.ReplaceQueryParameter(
            authorizationUrl,
            "redirect_uri",
            "https://heyalan.test/api/auth/providers/square/callback");
        ...
        Assert.Equal("https://heyalan.test/api/auth/providers/square/callback", query["redirect_uri"].ToString());
    }
