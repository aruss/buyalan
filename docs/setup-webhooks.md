...
Use this guide to expose local `BuyAlan.WebApi` endpoints for Telegram and Twilio webhook testing.

## Local Tunnel via ngrok

BuyAlan AppHost supports ngrok-driven local webhook exposure.
