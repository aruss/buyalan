...
- [ ] Add admin breadcrumb map module (`BuyAlan.WebApp/src/lib/admin-breadcrumbs.ts`) with a named export for resolving items from a pathname.
...
- [ ] Update `BuyAlan.WebApp/src/components/admin/ui/navigation/Breadcrumbs.tsx` to derive items from pathname using the route map.
...
- [ ] Remove breadcrumb `useEffect` setters from:
  - `BuyAlan.WebApp/src/app/admin/home/page.tsx`
  - `BuyAlan.WebApp/src/app/admin/inbox/page.tsx`
  - `BuyAlan.WebApp/src/app/admin/settings/page.tsx`
