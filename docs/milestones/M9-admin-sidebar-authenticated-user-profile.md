...
- [x] Sidebar profile UI is hardcoded with static user values:
  - `BuyAlan.WebApp/src/components/admin/ui/navigation/UserProfile.tsx`
  - `BuyAlan.WebApp/src/components/admin/ui/navigation/DropdownUserProfile.tsx`
...
- [x] Update `BuyAlan.WebApp/src/lib/session-context.tsx`:
...
- [x] Add client component (new file) for admin provider composition, e.g.:
  - [x] `BuyAlan.WebApp/src/app/admin/admin-shell.tsx`
...
- [x] Update `BuyAlan.WebApp/src/app/admin/layout.tsx`:
...
- [x] Update `BuyAlan.WebApp/src/components/admin/ui/navigation/UserProfile.tsx`:
...
- [x] Update `BuyAlan.WebApp/src/components/admin/ui/navigation/DropdownUserProfile.tsx`:
