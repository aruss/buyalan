...
namespace BuyAlan.Initializer.Migrations
{
    ...
    [Migration("20260313221316_Intivitations")]
    partial class Intivitations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.Agent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.AgentCatalogProductAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.AgentSalesZipCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ActiveSubscriptionId")
                        .HasDatabaseName("srbd_ix_srbd_asp_net_users_active_subscription_id");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.ConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.CreditTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SquareWebhookReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionCatalogProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionCatalogProductLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionCatalogSyncState", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("srbd_pk_srbd_subscription_invitations");

                    b.HasIndex("InvitedByUserId")
                        .HasDatabaseName("srbd_ix_srbd_subscription_invitations_invited_by_user_id");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("srbd_ix_srbd_subscription_invitations_token");

                    b.HasIndex("SubscriptionId", "Email")
                        .HasDatabaseName("srbd_ix_srbd_subscription_invitations_subscription_id_email");

                    b.ToTable("srbd_subscription_invitations");
                });

            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionOnboardingState", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionSquareConnection", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionUser", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.Agent", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "Subscription")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.AgentCatalogProductAccess", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.Agent", "Agent")
                    ...
                    b.HasOne("BuyAlan.Data.Entities.SubscriptionCatalogProduct", "SubscriptionCatalogProduct")
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.ApplicationUser", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "ActiveSubscription")
                        .WithMany()
                        .HasForeignKey("ActiveSubscriptionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("srbd_fk_srbd_asp_net_users_subscriptions_active_subscription_id");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.ConversationMessage", b =>
                {
                    ...
                    b.HasOne("BuyAlan.Data.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionCatalogSyncState", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "Subscription")
                        ...
                        .HasForeignKey("BuyAlan.Data.Entities.SubscriptionCatalogSyncState", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionInvitation", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.ApplicationUser", "InvitedByUser")
                        .WithMany()
                        .HasForeignKey("InvitedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("srbd_fk_srbd_subscription_invitations_srbd_asp_net_users_invited_by_u~");
                    ...
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "Subscription")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("srbd_fk_srbd_subscription_invitations_srbd_subscriptions_subscripti~");
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionOnboardingState", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.Agent", "PrimaryAgent")
                        .WithMany()
                    ...
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "Subscription")
                        ...
                        .HasForeignKey("BuyAlan.Data.Entities.SubscriptionOnboardingState", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionSquareConnection", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.ApplicationUser", "ConnectedByUser")
                        .WithMany()
                    ...
                    b.HasOne("BuyAlan.Data.Entities.Subscription", "Subscription")
                        ...
                        .HasForeignKey("BuyAlan.Data.Entities.SubscriptionSquareConnection", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BuyAlan.Data.Entities.SubscriptionUser", b =>
                {
                    ...
                    b.HasOne("BuyAlan.Data.Entities.ApplicationUser", "User")
                        .WithMany("SubscriptionUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BuyAlan.Data.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
