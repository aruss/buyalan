...
**Operational Notes**
- Reads connection string `buyalan` and `ADMIN_EMAIL` / `ADMIN_PASSWORD` from configuration.
...
run it from solution root
	...
	dotnet ef dbcontext optimize --project BuyAlan.Data --startup-project BuyAlan.Initializer --output-dir CompiledModels --namespace BuyAlan.Data.CompiledModels
